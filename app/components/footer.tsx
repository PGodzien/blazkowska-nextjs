    ...
    return (
        ...
        <>
            <section className="py-12 mt-8 bg-primary">
                <div className="container flex flex-col items-center text-center md:text-left md:flex-row space-y-8 md:space-y-0 justify-evenly px-4 mx-auto max-w-7xl text-white font-bold text-xl">
                    <div className="">
